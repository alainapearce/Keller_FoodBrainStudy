function results = mfit_wrapper_pearcef32_aci
...
%   aic: Akaike information criterion for fit model
    ...
    %(individual path info '...RO1_Brain_Mechanisms_IRB_5357/Participant_Data/BIDSdat/code/Kool2016_Model')
...
%     end
    ...
    %use all characters in path name upto the slash (individual path info
    %'.../RO1_Brain_Mechanisms_IRB_5357/Participant_Data/BIDSdat)
...
%             results(m).opts = opts(model);
            ...
            SpaceGame_DM_dat_session.sub(rowstart:rowend) = num2cell(res.ParID(res_ind));
