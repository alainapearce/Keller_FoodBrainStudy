...
def gen_index_byrun(onset_dir, nruns, preproc_path = False):
    ...
    Outputs:
        1 "index file" (text file) with list of subject IDs -- 1 for whole sample
    ...
    for group in index_dict:
        ...
        # set file name
        file = base_directory.joinpath('derivatives/analyses/foodcue-paper2/level2/index_' + group + '_' + str(censor_string) + '_' + str(nruns) + 'runs.txt')
